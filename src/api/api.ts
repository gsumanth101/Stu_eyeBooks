...
export const facultyLogin = async (loginRequest: LoginRequest): Promise<LoginResponse> => {
...
export const studentLogin = async (loginRequest: LoginRequest): Promise<LoginResponse> => {
...
export const getStudentProfile = async (): Promise<ProfileResponse> => {
